    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          className={`w-full px-3 py-2 rounded-lg border bg-white text-sm text-gray-900 placeholder:text-gray-400 transition-all duration-200 resize-none min-h-[100px] ${
            hasError
              ? "border-coral-500 ring-4 ring-coral-500/10"
